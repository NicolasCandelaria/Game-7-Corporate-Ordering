...
/** Mono spec readout: placements, decoration methods, notes. */
    ...
    <div className="g7-mono rounded-[2px] border border-g7-line text-xs">
      ...
      <dl>
        ...
        <div className="flex flex-col gap-1 px-4 py-3 sm:grid sm:grid-cols-[110px_1fr] sm:gap-4">
          <dt className="text-g7-offwhite/50">Notes</dt>
          <dd className="normal-case tracking-normal text-g7-offwhite/70">
            {spec.notes ?? "Placement and decoration method customizable."}
          </dd>
        </div>
      </dl>
    </div>
